...
- Compose profiles control what starts:
  ...
  - **SERVICES**: Spring/Quarkus/Micronaut/Helidon/Spark/Javalin/Dropwizard/Vert.x/Go service containers
...
- `services/java/` contains JVM frameworks (Spring, Quarkus, Micronaut, Helidon, Spark, Javalin, Dropwizard, Vert.x, … depending on what's implemented).
