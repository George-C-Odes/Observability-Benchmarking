...
export const POST = withApiRoute(
  { name: 'ORCH_SUBMIT_API' },
  async function POST(request: NextRequest, ctx) {
    ...
    try {
      ...
      serverLogger.debug('Submit request received', {
      ...
      try {
        ...
        return errorJson(502, {
          ...
          message: msg || 'Orchestrator submit failed.',
        });
      }
      ...
      serverLogger.debug('Job submitted', {
        jobId,
        runId: runId ?? null,
