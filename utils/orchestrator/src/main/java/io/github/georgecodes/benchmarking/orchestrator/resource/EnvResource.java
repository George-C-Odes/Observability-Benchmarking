...
/**
 * REST resource for managing environment configuration files. Provides endpoints for retrieving and
 * updating the compose/.env file. Delegates business logic to {@link EnvFileService}.
 */
@Path("/v1/env")
...
public class EnvResource {
  ...
  /**
   * Update the environment file with new content. Creates a backup before modifying.
   *
