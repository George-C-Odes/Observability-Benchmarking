...
In particular, native-image builds may use `container-registry.oracle.com/graalvm/native-image:25.0.4-ol9`. If you use those images, you are responsible for reviewing and complying with Oracle’s license terms.
