...
- Quarkus 3.37.3 (JVM and Native)
  - Platform threads
  - Virtual threads
  - Reactive (Mutiny)
- Micronaut 5.1.10 (JVM and Native)
  - Platform threads
  - Virtual threads
  - Reactive (Reactor)
- Helidon SE 4.5.1 (JVM and Native)
  - Virtual threads (Helidon 4 is virtual-thread–first)
- Helidon MP 4.5.1 (JVM and Native)
...
- Go 1.26.5
  - Fiber framework (v3.4.0)
- Django 6.0.7 (CPython)
