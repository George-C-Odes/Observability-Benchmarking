...
-H:+SharedArenaSupport                     # Netty shared-arena direct buffers
...
```
┌──────────────────────────────────────────────────────────┐
│  Stage 1: builder (GraalVM native-image:25.0.4-ol9)     │
...
### Prerequisites
- GraalVM Native Image 25.0.4+ (Enterprise recommended for G1 GC)
