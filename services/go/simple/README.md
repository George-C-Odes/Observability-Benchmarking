...
## Overview
A high-performance REST service implementation written in Go using the Fiber web framework (v3.1.0). This service provides a simple endpoint for benchmarking under high concurrency scenarios with full observability integration.
...
### Framework & Runtime
- **Language**: Go 1.26.1
- **Web Framework**: Fiber v3.1.0 (Express-inspired web framework)
