...
## Overview
A high-performance REST service implementation built with Quarkus 3.39.3 running on the Java Virtual Machine (JVM 25). This service supports three different thread models in a single deployment, making it ideal for benchmarking different concurrency approaches.
...
**Image**: `quarkus-jvm:3.39.3_latest`
