...
- Spring Boot 4.1.1 (JVM and Native)
  - Platform threads
  - Virtual threads
  - Reactive (WebFlux - Reactor)
- Quarkus 3.39.2 (JVM and Native)
  - Platform threads
  - Virtual threads
  - Reactive (Mutiny)
- Micronaut 5.1.13 (JVM and Native)
  - Platform threads
  - Virtual threads
  - Reactive (Reactor)
- Helidon SE 4.5.4 (JVM and Native)
  - Virtual threads (Helidon 4 is virtual-thread–first)
- Helidon MP 4.5.4 (JVM and Native)
...
- Go 1.27.1
  - Fiber framework (v3.5.0)
- Django 6.1.1 (CPython)
