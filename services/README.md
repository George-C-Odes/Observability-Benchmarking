...
Native builder image pull from Oracle Enterprise:
  ```bash
docker pull container-registry.oracle.com/graalvm/native-image:25.0.4-ol9
  ```
Native builder image pull from GraalVM community:
  ```bash
docker pull ghcr.io/graalvm/native-image-community:25.0.4-ol9
  ```
...
docker buildx build `
  ...
  -t spring-jvm-tomcat-platform:4.1.1_latest `
  --build-arg PROFILE=tomcat `
  --build-arg SPRING_BOOT_VERSION=4.1.1 `
  --build-arg BUILDKIT_BUILD_NAME=spring-jvm-tomcat-platform:4.1.1_latest `
  --load `
  services/java
```
...
docker buildx build `
    -f services/java/spring/jvm/Dockerfile `
    -t spring-jvm-tomcat-virtual:4.1.1_latest `
    --build-arg PROFILE=tomcat `
    --build-arg SPRING_BOOT_VERSION=4.1.1 `
    --build-arg BUILDKIT_BUILD_NAME=spring-jvm-tomcat-virtual:4.1.1_latest `
    --load `
    services/java
```
**spring-jvm-netty**
...
docker buildx build `
  -f services/java/spring/jvm/Dockerfile `
  -t spring-jvm-netty:4.1.1_latest `
  --build-arg PROFILE=netty `
  --build-arg SPRING_BOOT_VERSION=4.1.1 `
  --build-arg BUILDKIT_BUILD_NAME=spring-jvm-netty:4.1.1_latest `
  --load `
  services/java
```
...
docker buildx build `
  ...
  -t spring-native-tomcat-platform:4.1.1_latest `
  --build-arg PROFILE=tomcat `
  --build-arg VIRTUAL_ENABLED=false `
  --build-arg SPRING_BOOT_VERSION=4.1.1 `
  --build-arg BUILDKIT_BUILD_NAME=spring-native-tomcat-platform:4.1.1_latest `
  --load `
  services/java
```
...
docker buildx build `
  -f services/java/spring/native/Dockerfile `
  -t spring-native-tomcat-virtual:4.1.1_latest `
  --build-arg PROFILE=tomcat `
  --build-arg VIRTUAL_ENABLED=true `
  --build-arg SPRING_BOOT_VERSION=4.1.1 `
  --build-arg BUILDKIT_BUILD_NAME=spring-native-tomcat-virtual:4.1.1_latest `
  --load `
  services/java
```
**spring-native-netty**
...
docker buildx build `
  -f services/java/spring/native/Dockerfile `
  -t spring-native-netty:4.1.1_latest `
  --build-arg PROFILE=netty `
  --build-arg VIRTUAL_ENABLED=false `
  --build-arg SPRING_BOOT_VERSION=4.1.1 `
  --build-arg BUILDKIT_BUILD_NAME=spring-native-netty:4.1.1_latest `
  --load `
  services/java
```
**quarkus-jvm**
...
docker buildx build `
  ...
  -t quarkus-jvm:3.39.2_latest `
  --build-arg QUARKUS_VERSION=3.39.2 `
  --build-arg BUILDKIT_BUILD_NAME=quarkus-jvm:3.39.2_latest `
  --load `
  services/java
```
**quarkus-native**
...
docker buildx build `
    ...
    -t quarkus-native:3.39.2_latest `
    --build-arg QUARKUS_VERSION=3.39.2 `
    --build-arg BUILDKIT_BUILD_NAME=quarkus-native:3.39.2_latest `
    --load `
    services/java
```
**micronaut-jvm**
...
docker buildx build `
  ...
  -t micronaut-jvm:5.1.13_latest `
  --build-arg MICRONAUT_VERSION=5.1.13 `
  --build-arg BUILDKIT_BUILD_NAME=micronaut-jvm:5.1.13_latest `
  --load `
  services/java
```
**micronaut-native**
...
docker buildx build `
  ...
  -t micronaut-native:5.1.13_latest `
  --build-arg MICRONAUT_VERSION=5.1.13 `
  --build-arg BUILDKIT_BUILD_NAME=micronaut-native:5.1.13_latest `
  --load `
  services/java
```
**helidon-se-jvm**
...
docker buildx build `
  ...
  -t helidon-se-jvm:4.5.4_latest `
  --build-arg HELIDON_VERSION=4.5.4 `
  --build-arg BUILDKIT_BUILD_NAME=helidon-se-jvm:4.5.4_latest `
  --load `
  services/java
```
**helidon-se-native**
...
docker buildx build `
  ...
  -t helidon-se-native:4.5.4_latest `
  --build-arg HELIDON_VERSION=4.5.4 `
  --build-arg BUILDKIT_BUILD_NAME=helidon-se-native:4.5.4_latest `
  --load `
  services/java
```
**helidon-mp-jvm**
...
docker buildx build `
  ...
  -t helidon-mp-native:4.5.4_latest `
  --build-arg HELIDON_VERSION=4.5.4 `
  --build-arg BUILDKIT_BUILD_NAME=helidon-mp-native:4.5.4_latest `
  --load `
  services/java
```
**spark-jvm-platform**
...
docker buildx build `
  ...
  -t vertx-jvm:5.1.7_latest `
  --build-arg VERTX_VERSION=5.1.7 `
  --build-arg BUILDKIT_BUILD_NAME=vertx-jvm:5.1.7_latest `
  --load `
  services/java
```
**pekko-jvm**
...
docker buildx build `
    ...
    --build-arg BUILDKIT_BUILD_NAME=go:1.27.1_latest `
    --load `
...
docker buildx build `
    ...
    -t django-platform:6.1.1_latest `
    --build-arg PYTHON_VERSION=3.13.15 `
    --build-arg BUILDKIT_BUILD_NAME=django-platform:6.1.1_latest `
    --load `
...
docker buildx build `
    ...
    -t django-reactive:6.1.1_latest `
    --build-arg PYTHON_VERSION=3.13.15 `
    --build-arg BUILDKIT_BUILD_NAME=django-reactive:6.1.1_latest `
    --load `
    services/python/django
```
