...
docker buildx build `
  ...
  -t quarkus-jvm:3.30.5_latest `
  --build-arg QUARKUS_VERSION=3.30.5 `
  --build-arg BUILDKIT_BUILD_NAME=quarkus-jvm:3.30.5_latest `
  --load `
  services/java
```
**quarkus-native**
...
docker buildx build `
    ...
    -t quarkus-native:3.30.5_latest `
    --build-arg QUARKUS_VERSION=3.30.5 `
    --build-arg BUILDKIT_BUILD_NAME=quarkus-native:3.30.5_latest `
    --load `
    services/java
```
**go**
