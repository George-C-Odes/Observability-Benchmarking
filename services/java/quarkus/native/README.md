<!-- Generated from `services/java/quarkus/native/README.template.md` via `scripts/render-readmes.mjs`. Do not edit `services/java/quarkus/native/README.md` directly. -->

# Quarkus Native Service

## Overview
A high-performance REST service implementation built with Quarkus 3.36.3 compiled to a native executable using GraalVM Native Image. This service supports three different thread models in a single deployment, offering fast startup times and low memory footprint.
