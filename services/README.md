...
docker buildx build `
  ...
  -t micronaut-jvm:5.1.12_latest `
  --build-arg MICRONAUT_VERSION=5.1.12 `
  --build-arg BUILDKIT_BUILD_NAME=micronaut-jvm:5.1.12_latest `
  --load `
  services/java
```
**micronaut-native**
...
docker buildx build `
  ...
  -t micronaut-native:5.1.12_latest `
  --build-arg MICRONAUT_VERSION=5.1.12 `
  --build-arg BUILDKIT_BUILD_NAME=micronaut-native:5.1.12_latest `
  --load `
  services/java
```
**helidon-se-jvm**
