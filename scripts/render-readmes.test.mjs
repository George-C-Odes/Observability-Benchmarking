...
`);
  ...
  assert.equal(env.SPRING_BOOT_VERSION, '4.1.1');
...
function testGeneratedOutputRoundTrip() {
  ...
  try {
    ...
    writeFileSync(outputPath, 'Version 4.1.1', 'utf8');
...
function testRenderTemplatesResolvesRelativeEnvPath() {
  ...
  try {
    ...
    assert.equal(readFileSync(outputPath, 'utf8'), 'Spring 4.1.1 / Quarkus 3.38.3');
  } finally {
    try {
