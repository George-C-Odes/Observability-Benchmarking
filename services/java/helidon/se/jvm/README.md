...
## Overview
A high-performance REST service implementation built with Helidon 4.5.2 (SE/Níma) running on the Java Virtual Machine (JVM 25). Helidon 4 is virtual-thread–first and dropped the reactive programming model, making it ideal for benchmarking virtual thread performance with minimal framework overhead.
...
**Image**: `helidon-se-jvm:4.5.2_latest`
