...
## Overview
A high-performance REST service implementation built with Helidon 4.5.1 MicroProfile running on the Java Virtual Machine (JVM 25). Helidon 4 MP uses CDI (Weld) for dependency injection, JAX-RS (Jersey) for routing, and virtual threads by default for every request handler.
...
### Framework & Runtime
- **Framework**: Helidon 4.5.1 MP (CDI + JAX-RS)
...
**Image**: `helidon-mp-jvm:4.5.1_latest`
