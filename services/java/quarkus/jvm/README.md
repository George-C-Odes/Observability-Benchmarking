...
## Overview
A high-performance REST service implementation built with Quarkus 3.39.2 running on the Java Virtual Machine (JVM 25). This service supports three different thread models in a single deployment, making it ideal for benchmarking different concurrency approaches.
...
**Image**: `quarkus-jvm:3.39.2_latest`
